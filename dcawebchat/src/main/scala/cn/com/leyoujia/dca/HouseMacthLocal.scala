...
import cn.com.leyoujia.dca.HouseMatchClient.{ClientMatchCount, ClientMatchDay, ClietInfo, HouseInfo, MatchFinal, MatchInfo}
...
object HouseMacthLocal {
  ...
  def process(spark: SparkSession): Unit = {
    ...
    val tableDay = spark.table("tmp.house_match_client_day").rdd.map(d => d.getAs[String]("p_date")).collect()
